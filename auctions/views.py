...
from .forms import CreateAuctionForm, BidForm, CommentForm
...
def create(request):
    ...
    if request.method == "POST":
        ...
        for category in categories:
            if AuctionCategory.objects.get(pk=category):
                pass
            pass
        pass
        # if form.is_valid():
    ...
    # request.POST["categories"] or ""
    form.instance.categorires.set("ninguna")
